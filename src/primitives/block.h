...
public:
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // openchat
        hashUTXORoot.SetNull(); // openchat
        vchBlockSig.clear();
    ...
    virtual bool IsProofOfStake() const //openchat
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //openchat
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //openchat
    {
