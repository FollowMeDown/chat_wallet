...
////////////////////////////////////////////////////////////// openchat
        ...
        globalState = std::unique_ptr<OpenchatState>(new OpenchatState(dev::u256(0), OpenchatState::openDB(pathTemp.string(), hashDB, dev::WithExisting::Trust), pathTemp.string(), dev::eth::BaseState::Empty));
        dev::eth::ChainParams cp((dev::eth::genesisInfo(dev::eth::Network::openchatTestNetwork)));
