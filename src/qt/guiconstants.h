...
#define QAPP_ORG_NAME "openchat"
#define QAPP_ORG_DOMAIN "openchat.org"
#define QAPP_APP_NAME_DEFAULT "openchat-Qt"
#define QAPP_APP_NAME_TESTNET "openchat-Qt-testnet"
