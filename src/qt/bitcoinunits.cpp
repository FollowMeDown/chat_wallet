...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("openchat");
    case mBTC: return QString("mOPENCHAT");
    case uBTC: return QString::fromUtf8("μOPENCHAT");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Openchats");
    case mBTC: return QString("Milli-Openchats (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Openchats (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
