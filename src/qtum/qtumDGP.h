#ifndef OPENCHATDGP_H
#define OPENCHATDGP_H
...
public:
    ...
    OpenchatDGP(OpenchatState* _state, bool _dgpevm = true) : dgpevm(_dgpevm), state(_state) { initDataEIP158(); }
