...
/////////////////////////////////////////// openchat
#include <openchat/openchatstate.h>
#include <openchat/openchatDGP.h>
#include <libethereum/ChainParams.h>
#include <libethashseal/Ethash.h>
#include <libethashseal/GenesisInfo.h>
#include <script/standard.h>
#include <openchat/storageresults.h>


extern std::unique_ptr<OpenchatState> globalState;
...
using ExtractOpenchatTX = std::pair<std::vector<OpenchatTransaction>, std::vector<EthTransactionParams>>;
///////////////////////////////////////////
...
static const size_t MAX_CONTRACT_VOUTS = 1000; // openchat
...
void EnforceContractVoutLimit(ByteCodeExecResult& bcer, ByteCodeExecResult& bcerOut, const dev::h256& oldHashOpenchatRoot,
    const dev::h256& oldHashStateRoot, const std::vector<OpenchatTransaction>& transactions);
...
class OpenchatTxConverter{

public:

    OpenchatTxConverter(CTransaction tx, CCoinsViewCache* v = NULL, const std::vector<CTransactionRef>* blockTxs = NULL) : txBit(tx), view(v), blockTransactions(blockTxs){}

    bool extractionOpenchatTransactions(ExtractOpenchatTX& openchatTx);
...
private:
    ...
    OpenchatTransaction createEthTX(const EthTransactionParams& etp, const uint32_t nOut);
...
public:
    ...
    ByteCodeExec(const CBlock& _block, std::vector<OpenchatTransaction> _txs, const uint64_t _blockGasLimit) : txs(_txs), block(_block), blockGasLimit(_blockGasLimit) {}
