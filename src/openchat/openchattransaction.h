#ifndef OPENCHATTRANSACTION_H
#define OPENCHATTRANSACTION_H
...
class OpenchatTransaction : public dev::eth::Transaction{

public:

    OpenchatTransaction() : nVout(0) {}

    OpenchatTransaction(dev::u256 const& _value, dev::u256 const& _gasPrice, dev::u256 const& _gas, dev::bytes const& _data, dev::u256 const& _nonce = dev::Invalid256):
		dev::eth::Transaction(_value, _gasPrice, _gas, _data, _nonce) {}

    OpenchatTransaction(dev::u256 const& _value, dev::u256 const& _gasPrice, dev::u256 const& _gas, dev::Address const& _dest, dev::bytes const& _data, dev::u256 const& _nonce = dev::Invalid256):
